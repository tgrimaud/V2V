...
|---|---|---|---|---|
| TASK-WEB-007 | WebRTC transport (SmallWebRTCTransport + Pipecat JS client) on a single long-lived async loop | Transport/Enabler | High | Planned |
...
|---|---|---|
| TASK-WEB-007 | `task/TASK-WEB-007-webrtc-transport` | Planned |
