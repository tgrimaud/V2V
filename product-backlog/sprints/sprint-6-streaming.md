...
| TASK-STT-012 | Streaming VAD-based end-of-turn detection | Turn detection | Medium | Validated by user (review 93/100 + QA Go; merge-ready) |
| TASK-STT-010 | Streaming STT (partial + final transcripts) | STT | High | Implemented (live tail 818 ms vs ~3.4 s batch; RF-007 closed; pending review + QA) |
...
| TASK-STT-012 | `task/TASK-STT-012-streaming-vad-end-of-turn` | Validated by user (review 93/100 + QA Go; merge-ready) |
| TASK-STT-010 | `task/TASK-STT-010-streaming-stt` | Implemented (stacked on TASK-STT-012; live gate green; RF-007 closed; pending review + QA + user validation) |
