...
| TASK-INFRA-002 | HAProxy + Keepalived config for the two VIPs (voice `.10`→t01/t02 TLS edge, backend `.11`→t03/t04), health checks, finalized ports, VRRP failover — coordinated with the platform team | Wire (infra) | ✅ Implemented; ✅ adversarial 92/100 (Pass — VRRP unicast + ip_nonlocal_bind fixes); ✅ QA GO (25/25 incl. real `haproxy -c`, [report](../../docs/qa/task-infra-002-haproxy-vips-qa-report.md)); ✅ merge-ready |
