...
| TASK-STT-010 | Stream partial STT transcripts to cut perceived latency (closes RF-007) | V1 pilot gate | Planned (Sprint 6) | High |
...
| TASK-WEB-003-E | End-to-end backend telemetry + `BACKEND_FIRST_TOKEN` slice (closes US-036 gap) | V1 pilot gate | Implemented (Sprint 5; review 95/100; RF-021) — merge-ready, pending user validation | High |
