...
| TASK-BE-017 | Backend support for the voice latency levers — a cheap side-effect-free **warm-up path** (LLM + embedding, for lever 2 / TASK-WEB-021) + a **contract test** locking the `converse-stream` vetted-only invariant (for lever 1 / TASK-WEB-020), plus optional early confidence/grounding signal | V1 pilot gate (perceived latency) | To do (Sprint 10, branch `task/TASK-BE-017-voice-latency-support`); created 2026-07-29 as the backend dependency of TASK-WEB-020/021. ADR-0037 / ADR-0013 | High |
