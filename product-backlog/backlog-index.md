...
| TASK-DOC-006 | Clarify Genesys **AudioHook (protocol)** vs **Audio Connector (bidirectional feature)** as the V2V media plane: correct ADR-0020's interchangeable wording, add **ADR-0040** (media/control/context 3-plane split + Audio Connector constraints: premium, ≤5 integrations, 1 bidirectional stream/session, IVR channel, 15 min cap, PCMU/L16, native barge-in/end-of-turn overlap with ADR-0025), update the target diagram | Documentation + architecture | 🚧 In progress (branch `task/TASK-DOC-006-genesys-audio-connector-media-plane`, off `feat/restart-from-scratch`). Not runtime-affecting. Full Genesys voice routing stays deferred to Sprint 13 (OQ-006). EPIC-001 / ADR-0020 / ADR-0019 / ADR-0040 — `tasks/doc-tasks.md` | Medium |
