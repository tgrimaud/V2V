...
| TASK-WEB-003-B | Deterministic stub backend adapter (default, offline/dev + tests) | V1 core | Implemented (Sprint 5; review 96/100; RF-017/RF-018) — merge-ready, pending user validation | High |
