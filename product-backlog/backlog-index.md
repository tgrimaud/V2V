...
| TASK-BE-018 | Concise voice-first answers — cap answer length via LLM prompt budget to cut TTS synthesis time (batch `/turn` ≈14 s, live tail); no grounding regression (BUG-004) | V1 answer quality / latency | In progress (2026-07-23) — implemented + unit-tested (`mvn test` 223 green, ArchUnit OK); awaiting adversarial review + QA/latency, ADR-0033/ADR-0029 | High |
