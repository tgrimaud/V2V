...
| SPRINT-10-PILOT-LATENCY | Pilot-readiness latency & perceived latency (EPIC-010 + EPIC-006/US-020) | Planned (next) — pilot-readiness latency theme, promoted ahead of billing by user decision (2026-07-29) | Validate and reduce **perceived** voice latency before the billing theme: close TASK-WEB-014 with a warm live sample + adversarial/QA, land the TASK-WEB-015 optimization levers, and add spoken filler/acknowledgement phrases (TASK-WEB-019 / US-020) so waits feel responsive — `sprints/sprint-10-pilot-latency.md` |
