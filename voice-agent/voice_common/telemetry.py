"""Domain-neutral, in-memory OpenTelemetry-style recorder shared across halves.

Cross-cutting utility used by both the STT (voice-in) and TTS (voice-out) halves
without either owning the other. It records events, timing spans, metric samples
and structured logs, and summarises latency samples into p50/p95/p99. No STT- or
TTS-specific concepts live here.
"""
