...
- grounding recall@8 ≥ 0.9: **FAIL** (0.86)
- phrasing-stability ≥ 0.9: **FAIL** (0.71)
- Miss breakdown (top-8): guardrail-block **2**, retrieval-eviction **2** (of 29 variants)

## Aggregates

| Scope | recall@4 | recall@8 | MRR | stability | block | evict | q | v |
|---|---|---|---|---|---|---|---|---|
| overall | 0.83 | 0.86 | 0.76 | 0.71 | 2 | 2 | 14 | 29 |
| language=en | 0.50 | 0.67 | 0.45 | 0.33 | 2 | 0 | 3 | 6 |
| language=fr | 0.91 | 0.91 | 0.84 | 0.82 | 0 | 2 | 11 | 23 |
| domain=billing | 1.00 | 1.00 | 0.90 | 1.00 | 0 | 0 | 6 | 12 |
| domain=commercial | 1.00 | 1.00 | 1.00 | 1.00 | 0 | 0 | 2 | 4 |
| domain=support | 0.62 | 0.69 | 0.55 | 0.33 | 2 | 2 | 6 | 13 |
...
| sup-fr-tv | fr | support | 1/2 | 1 | yes | retrieval |
| sup-en-internet | en | support | 1/2 | 5 | yes | guardrail |
