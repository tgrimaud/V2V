...
**Status:** Implemented — 2026-09-11. **Decisions D1–D3 locked (2026-09-10, see §3);** ADR-0052 Accepted; sub-tasks 1–8 done (see §6), all backend tests + ArchUnit green and the Spring context boots. Remaining: docs (this update) + adversarial review before QA.
...
1. **ADR-0052** — record the billing↔answer integration decision (D1a evidence injection,
   D2a deterministic intent detector, D3c dedicated endpoint, escalation mapping). ✅ **Written +
   Accepted (2026-09-11)** — `docs/architecture/adrs/ADR-0052-billing-explanation-behind-the-answer-engine.md`.
...
9. Docs: architecture.md + API docs (new endpoint) + ADR-0052 (this update); **adversarial review
   before QA** (next).
