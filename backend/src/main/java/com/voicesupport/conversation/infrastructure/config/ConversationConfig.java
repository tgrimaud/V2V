...
public class ConversationConfig {
    ...
    // Escalation hand-off wiring (escalationHandoffPort / factory / service) lives in
    // EscalationHandoffConfig — extracted to keep this class within the 200-line budget.
